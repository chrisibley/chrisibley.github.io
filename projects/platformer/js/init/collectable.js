(function (window) {
    ...
    collectable.init = function (game) {
        ...
        collectable.create(type.grace, 300, 270, 3, 3);
        collectable.create(type.kennedi,275, 70, 8.5, 0);
        collectable.create(type.max, 175, 140, 5, 2);
        collectable.create(type.db, 455, 475, 5, 0);
